...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"spa"), pos = wx.DefaultPosition, size = wx.Size( 708,369 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.m_brouseInputFileName = wx.Button( self, wx.ID_ANY, _(u"Browse"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        m_fileFormatChoices = [ _(u"Real CSV"), _(u"Complex CSV"), _(u"Real BIN"), _(u"Complex BIN") ]
        ...
        self.m_analyze = wx.Button( self, wx.ID_ANY, _(u"Analyze"), wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer4.Add( self.m_analyze, 0, wx.ALL, 5 )
        ...
        self.m_analyze.Bind( wx.EVT_BUTTON, self.onButtonClickExecute )
